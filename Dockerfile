...
RUN ln -s /usr/bin/php7 /usr/bin/php && sed -ie 's/-n//g' /usr/bin/pecl && pecl install libsodium && pecl install redis-3.1.3RC2 && curl -sS https://getcomposer.org/installer \
